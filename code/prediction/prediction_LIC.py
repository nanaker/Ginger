...
data_full_name = pd.read_csv('dataset/LIC/prediction/LIC_prediction.csv')

data=pd.read_csv('dataset/LIC/prediction/LIC_prediction.csv')
...
data2.to_csv('dataset/LIC/prediction_result2.csv', index=False)
