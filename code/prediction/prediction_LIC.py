...
data_full_name = pd.read_csv('../../prediction/LIC_prediction.csv')

data=pd.read_csv('../../prediction/LIC_prediction.csv')
...
data2.to_csv('../../result/prediction_result_LIC.csv', index=False)
