...
data_full_name = pd.read_csv('dataset/HBR/prediction/HBR_prediction.csv')

data=pd.read_csv('dataset/HBR/prediction/HBR_prediction.csv')
...
data2.to_csv('dataset/HBR/prediction_result2.csv', index=False)
