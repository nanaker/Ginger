...
##BLOB
datasetpath=["dataset/BLOB/taken/BLOB_del.csv","dataset/BLOB/taken/BLOB_RandomUnderSampler.csv","dataset/BLOB/taken/BLOB_AllKNN.csv","dataset/BLOB/taken/BLOB_InstanceHardnessThreshold.csv","dataset/BLOB/taken/BLOB_NearMiss.csv","dataset/BLOB/taken/BLOB_OneSidedSelection.csv","dataset/BLOB/taken/BLOB_RandomUnderSampler_default.csv","dataset/BLOB/taken/BLOB_TomekLinks.csv","dataset/BLOB/taken/BLOB_CondensedNearestNeighbour.csv"]

#df = pd.read_csv('dataset/BLOB/taken/BLOB_del.csv')
#df = pd.read_csv('dataset/BLOB/taken/BLOB_RandomUnderSampler.csv')
#df = pd.read_csv('dataset/BLOB/taken/BLOB_AllKNN.csv')
#df = pd.read_csv('dataset/BLOB/taken/BLOB_CondensedNearestNeighbour.csv')
#df = pd.read_csv('dataset/BLOB/taken/BLOB_InstanceHardnessThreshold.csv')
#df = pd.read_csv('dataset/BLOB/taken/BLOB_NearMiss.csv')
#df = pd.read_csv('dataset/BLOB/taken/BLOB_OneSidedSelection.csv')
#df = pd.read_csv('dataset/BLOB/taken/BLOB_RandomUnderSampler_default.csv')
#df = pd.read_csv('dataset/BLOB/taken/BLOB_TomekLinks.csv')
...
for j in range(4):
 ...
 for path in datasetpath:
    ...
    if((path=="dataset/BLOB/taken/BLOB_CondensedNearestNeighbour.csv")):
       continue
    ...
    #Visualisation
   # tree.export_graphviz(lr_model, out_file="dataset/BLOB/BLOB_model_tree",
...
result.to_csv('dataset/BLOB/BLOB_train_result.csv', index=False)
