...
df = pd.read_csv('dataset/BLOB/BLOB_.csv')
...
X_resampled.columns =['lack_of_cohesion_in_methods','number_of_methods','number_of_attributes']
...
undersampled_data.to_csv('dataset/BLOB_RandomUnderSampler_default.csv', index=False)
...
print(undersampled_data['is_code_smell'].describe())
print(undersampled_data.describe())
undersampled_data.to_csv('dataset/BLOB_RandomUnderSampler.csv', index=False)
...
print(undersampled_data['is_code_smell'].describe())
print(undersampled_data.describe())
undersampled_data.to_csv('dataset/BLOB_AllKNN.csv', index=False)
...
print(undersampled_data['is_code_smell'].describe())
print(undersampled_data.describe())
undersampled_data.to_csv('dataset/BLOB_CondensedNearestNeighbour.csv', index=False)
#
#
#
...
print(undersampled_data['is_code_smell'].describe())
print(undersampled_data.describe())
undersampled_data.to_csv('dataset/BLOB_TomekLinks.csv', index=False)
...
print(undersampled_data['is_code_smell'].describe())
print(undersampled_data.describe())
undersampled_data.to_csv('dataset/BLOB_InstanceHardnessThreshold.csv', index=False)
...
print(undersampled_data['is_code_smell'].describe())
print(undersampled_data.describe())
undersampled_data.to_csv('dataset/BLOB_NearMiss.csv', index=False)
...
print(undersampled_data['is_code_smell'].describe())
print(undersampled_data.describe())
undersampled_data.to_csv('dataset/BLOB_OneSidedSelection.csv', index=False)
