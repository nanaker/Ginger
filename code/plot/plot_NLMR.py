...
df = pd.read_csv('dataset/NLMR/NLMR_train_result2.csv')
...
print(NearMiss)
TomekLinks=(df_decision_tree['F_mesure'].iloc[5],df_random_forest['F_mesure'].iloc[5],df_naive_bayes['F_mesure'].iloc[6],df_svm['F_mesure'].iloc[5])
print(TomekLinks)
...
#ax.set_title('Résultat de classification  par dataset et par Algorithme du défaut de code NLMR')
