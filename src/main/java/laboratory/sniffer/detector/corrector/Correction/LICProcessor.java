...
public class LICProcessor extends AbstractProcessor<CtClass> {
    ...
    public void process(CtClass element) {
        ...
        //System.out.println("in lic process "+element.getQualifiedName());
        //System.out.println("in lic process getClass"+element.getParent().getParent().getClass());
    ...
    private String getVariableName(CtClass element){
        ...
        splitName=variableName.split("\\.");
        variableName=splitName[splitName.length-1];
